...
public class RideByStatus extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    // ✅ Validate input
	    if (!InputValidator.validate("getRidebyStatus", queryParams)) {
	        ...
	        List<RideHistory> rideHistoryList = historyService.getRideStatus(userId,status);
